...
<body class="bg-gray-200 w-screen h-screen flex justify-center items-center">
    ...
    <div
        ...
        <div class="w-full h-full flex flex-col p-2 items-center">
            <div class="mt-6">
                <p class="text-xl uppercase font-semibold">Login to your account</p>
            </div>
            <form action="{{ route('login-p') }}" method="POST">
                ...
                <div class=" w-full mt-5 space-y-5">
                    <div class="bg-white rounded-2xl h-10 w-full p-2 flex flex-row items-center gap-2 drop-shadow-lg">
                        ...
                        <div class="w-full h-full">
                            <input type="email" name="email" class="w-full h-full outline-none text-lg"
                                placeholder="email">
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl h-10 w-full p-2 flex flex-row items-center gap-2 drop-shadow-lg">
                        ...
                        <div class="w-full h-full">
                            <input type="password" name="password" class="w-full h-full outline-none text-lg"
                                placeholder="*******">
                        </div>
                    </div>
                ...
                <div class="w-full flex items-center justify-center mt-10">
                    <button
                        class="bg-white p-2 w-1/2 rounded-xl text-lg uppercase drop-shadow-2xl font-semibold">Login</button>
                </div>
            </form>
        </div>
